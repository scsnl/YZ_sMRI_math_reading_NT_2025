...
fname = project_dir + 'results/cca/combined_CCA_PCA_roi_smri_brainnetome_math_age_coefs_stanford_n231.csv'
# fname = project_dir + 'results/cca/combined_CCA_PCA_roi_smri_brainnetome_reading_age_coefs_stanford_n231.csv'
output_file = project_dir + '/results/cca/CCA_PCA_roi_gmv_brainnetome_mathstd_ageinmodel_individual_neurotransmitter_regression_results_stanford_n231.csv'
# output_file = project_dir + '/results/cca/CCA_PCA_roi_gmv_brainnetome_readstd_ageinmodel_individual_neurotransmitter_regression_results_stanford_n231.csv'
# idx_list = [1,3]
idx_list = [3]
