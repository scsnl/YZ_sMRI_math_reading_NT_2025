...
regress_out_age <- function(data){
  ...
  mod_mathprob_std = lm(mathprob_std ~ age, data=beh) 
  mathprob_std_resid = resid(mod_mathprob_std)
  ...
  beh$mathprob_std_resid = mathprob_std_resid
  ...
  out = list(beh=beh, brain_resid=brain_resid, mod_list=mod_list, 
             ...
             mod_mathprob_std=mod_mathprob_std, mod_readcomp_std=mod_readcomp_std)
