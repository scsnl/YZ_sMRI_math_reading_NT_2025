...
# while controlling for age. PCA is used on GMV data for
...
# Output settings
output_path <- "results/cca/cmi/wholebrain_cca_cmi_math_reading_combined"
postfix     <- "mathreadingstd_ageinmodel"
cols        <- c("age", "numop_std", "mathprob_std", "wordread_std", "readcomp_std")
