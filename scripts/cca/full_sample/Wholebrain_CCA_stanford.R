...
#  1) Math uses "numop_std" and "mathrea_std"
...
analyses <- list(
  math = list(
    output_path = "results/cca/stanford/wholebrain_cca_stanford_math",
    postfix     = "mathstd_ageinmodel",
    cols        = c("age", "numop_std", "mathrea_std")
  ),
  reading = list(
    output_path = "results/cca/stanford/wholebrain_cca_stanford_reading",
