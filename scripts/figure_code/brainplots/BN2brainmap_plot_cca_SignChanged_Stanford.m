...
% fname = sprintf('%s/results/cca/combined_CCA_PCA_roi_smri_brainnetome_math_age_coefs_stanford_n231.csv',project_path);
fname = sprintf('%s/results/cca/combined_CCA_PCA_roi_smri_brainnetome_reading_age_coefs_stanford_n231.csv',project_path);
...
for i = 4
    ...
    % end
    % output_file = sprintf('%s/results/cca/brainmaps/%s_ageinmodel_SignChanged_cca_stanford_n231.nii',project_path, colnames{i});
    ...
    idx_output_f = sprintf('%s/results/cca/brainmaps/%s_thr%d_SignChanged_cca_stanford_n231.csv',project_path,colnames{i}, thresh);
    ...
    output_file = sprintf('%s/results/cca/brainmaps/%s_thr%d_SignChanged_cca_stanford_n231.nii',project_path,colnames{i}, thresh);
    ...
    % output_figure = sprintf('%s/results/cca/brainmaps/%s_%s.jpg',project_path, colnames{i},preset);
    % output_figure = sprintf('%s/results/cca/brainmaps/%s_%s_SignChanged_cca_stanford_n231.jpg',project_path, colnames{i},preset);
    output_figure = sprintf('%s/results/cca/brainmaps/%s_%s_thr%d_SignChanged_cca_stanford_n231.jpg',project_path, colnames{i},preset,thresh);
    % output_figure = sprintf('%s/results/cca/brainmaps/%s_%s_thr%d.jpg', project_path, colnames{i}, preset, thresh);
    % output_figure = sprintf('%s/results/cca/brainmaps/%s_%s_thr%d_SignChanged.jpg', project_path, colnames{i}, preset, thresh);
